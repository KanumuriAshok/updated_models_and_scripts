...
class ConstrainedKMeansAlgorithm(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'min_max_kmeans2'

    def displayName(self):
        return self.tr('Min Max K-Means Clustering Street Constraint')
        
    def shortHelpString(self):
        return self.tr('Min Max K-Means Clustering Street Constraint algorithm PyQGIS implementation')
