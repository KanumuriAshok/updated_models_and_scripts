...
class Secondary_hybrid_np(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['Hybrid_nodeplacement'] = processing.run('model:hybrid_nodeplacement', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
