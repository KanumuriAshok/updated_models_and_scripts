...
class Secondary_preprocessdp(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['Missingdemandpoints'] = processing.run('model:missingdemandpoints', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['Preprocessed_dp'] = outputs['Missingdemandpoints']['native:mergevectorlayers_3:preprocessed_dp']
        return results

    def name(self):
        return 'secondary_preprocessdp'
